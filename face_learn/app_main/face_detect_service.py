...
class FaceDetectService:
    ...
    def eye_detect(self):
        ...
        eyes = self.classifiers[1].detectMultiScale(
            roi_gray,
            scaleFactor=1.2,
            minNeighbors=10,
            minSize=(5, 5)
    ...
    def face_recog(self):
        ...
        for (x,y,w,h) in self.face:
            ...
            if confi <50:#0에 가까울수록 학습한 데이터에 판별할 데이터가 유사함.
                name = names[id]
